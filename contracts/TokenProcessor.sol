...
contract TokenProcessor {
    ...
    IERC20 public constant crv_lp_tBTC =
        IERC20(0x64eda51d3Ad40D56b9dFc5554E06F94e1Dd786Fd);
    ...
    ICurveExchange public constant crvTBTC =
        ICurveExchange(0xC25099792E9349C7DD09759744ea681C7de2cb66);
    ...
    ISettV4 public constant bcrvTBTC =
        ISettV4(0xb9D076fDe463dbc9f915E5392F807315Bf940334);
    ...
    constructor() public {
        ...
        wbtcToken.approve(address(crvTBTC), type(uint256).max);
        ...
        crv_lp_tBTC.approve(address(bcrvTBTC), type(uint256).max);
    }

    function increasePpfs() external {
        ...
        uint256 lpBalance = crv_lp_renBTC.balanceOf(address(this));
